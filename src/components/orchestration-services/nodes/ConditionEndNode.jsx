...
class ConditionEndNodeModel extends DiamondNodeModel {
  initNodeData(data) {
...
// 自定义节点的 view
class ConditionEndNodeView extends DiamondNode {
  getLabelShape() {
...
export default {
  ...
  view: ConditionEndNodeView,
  model: ConditionEndNodeModel
};
